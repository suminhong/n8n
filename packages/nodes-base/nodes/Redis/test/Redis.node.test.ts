...
master_failover_state:no-failover
	`);
			...
			it('should return an error when continue on fail is enabled', async () => {
				thisArg.getNodeParameter.calledWith('operation', 0).mockReturnValue('info');
			...
			it('should throw an error on continue on fail', async () => {
				thisArg.getNodeParameter.calledWith('operation', 0).mockReturnValue('info');
		...
		describe('get operation', () => {
			...
			it('should throw an error when continue on fail is enabled', async () => {
				thisArg.getNodeParameter.calledWith('keyType', 0).mockReturnValue('automatic');
